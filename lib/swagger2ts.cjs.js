...
const replaceDefinitions = (str) => str.replace('#/definitions/', '');
...
class API {
    constructor({ method, pathConfig }) {
        ...
        Object.defineProperty(this, "pathConfig", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "apiDescription", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "effectTypesWithParseAPI", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    genDescription(parameter) {
        const { description } = parameter;
        return `${description ? `\n\t/** ${description} */\n` : ''}`;
    }
    genParameter(parameter) {
        ...
        if (type) {
            ...
            if (items) {
                ...
                if (rowEnum) {
                    ...
                    return `\t${name}${!required ? '?' : ''}:${transformType(rowType)}${type === 'array' ? '[]' : ''}, `;
                }
            }
...
class Interface {
    constructor(interfaceInfo) {
        ...
        Object.defineProperty(this, "interfaceValue", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "effectTypesWithParseInterface", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
const transformDefinitions = (definitions) => {
    ...
    for (const interfaceName in definitions) {
        ...
        definitionsResult.push(new Interface({
            interfaceName,
            interfaceConfig
        }));
    }
...
exports.fileLoader = fs__default["default"].readFileSync;
...
const genCode = async (resolvedConfig) => {
    const { pathsResult, definitionsResult, effectTypesWithParsePaths, effectTypesWithParseInterface } = resolvedConfig;
